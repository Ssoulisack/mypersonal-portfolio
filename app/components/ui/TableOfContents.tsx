              ...
              return (
                ...
                >
                  <Link
                    ...
                    className={cn(
                      'prose relative py-1.5 my-4 text-sm transition-colors [overflow-wrap:anywhere] first:pt-0 last:pb-0 block',
                      isActive
                        ? 'text-white'
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        'absolute inset-y-0 w-[2px] rounded-full bg-white/10 transition-colors',
                        isActive && 'bg-white/30',
                        index < data.items.length - 1 && 'bottom-0'
                      )}
